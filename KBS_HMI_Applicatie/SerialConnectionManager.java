...
public class SerialConnectionManager extends JPanel{
    ...
    public SerialConnectionManager(Dimension screenDimension){
        ...
        Icon redIcon = new ImageIcon("KBS_HMI_Applicatie/Icons/redCircle.png");
        rood = new JLabel(redIcon);
        Icon greenIcon = new ImageIcon("KBS_HMI_Applicatie/Icons/greenCircle.png");
        ...
        Icon settingsIcon = new ImageIcon("KBS_HMI_Applicatie/Icons/settingsIcon.png");
